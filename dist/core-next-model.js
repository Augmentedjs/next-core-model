  ...
  return function (e) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 });const i = { INVALID_TYPE: 0, ENUM_MISMATCH: 1, ANY_OF_MISSING: 10, ONE_OF_MISSING: 11, ONE_OF_MULTIPLE: 12, NOT_PASSED: 13, NUMBER_MULTIPLE_OF: 100, NUMBER_MINIMUM: 101, NUMBER_MINIMUM_EXCLUSIVE: 102, NUMBER_MAXIMUM: 103, NUMBER_MAXIMUM_EXCLUSIVE: 104, NUMBER_NOT_A_NUMBER: 105, STRING_LENGTH_SHORT: 200, STRING_LENGTH_LONG: 201, STRING_PATTERN: 202, OBJECT_PROPERTIES_MINIMUM: 300, OBJECT_PROPERTIES_MAXIMUM: 301, OBJECT_REQUIRED: 302, OBJECT_ADDITIONAL_PROPERTIES: 303, OBJECT_DEPENDENCY_KEY: 304, ARRAY_LENGTH_SHORT: 400, ARRAY_LENGTH_LONG: 401, ARRAY_UNIQUE: 402, ARRAY_ADDITIONAL_ITEMS: 403, FORMAT_CUSTOM: 500, KEYWORD_CUSTOM: 501, CIRCULAR_REFERENCE: 600, UNKNOWN_PROPERTY: 1e3 };let n,
      ...
      constructor(e, t, r, i, n, s) {
        if (void 0 === e) throw new Error("No code supplied for error: " + t);this.message = t, this.params = r, this.code = e, this.dataPath = i || "", this.schemaPath = n || "", this.subErrors = s || null;const a = new Error(this.message);if (this.stack = a.stack || a.stacktrace, !this.stack) try {
          throw a;
        } catch (e) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 });const i = { $schema: "http://json-schema.org/draft-04/schema#", title: "model", description: "Generated Schema", type: "object", properties: {} };t.default = e => {
      let t,
          ...
          a = i,
          o = Object.keys(e),
          l = o.length;for (t = 0; t < l; t++) for (n in r = o[t]) if (r.hasOwnProperty(n)) {
        s = a.properties[r] = {};let t = typeof e[r];"object" === t ? t = Array.isArray(e[r]) ? "array" : "object" : "number" === t && (t = Number.isInteger(e[r]) ? "integer" : "number"), s.type = t, s.description = String(r);
      }return a;
    };
  }, function (e, t, r) {
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 });t.URI_TEMPLATE_GLOBAL_MODIFIERS = { "+": !0, "#": !0, ".": !0, "/": !0, ";": !0, "?": !0, "&": !0 }, t.URI_TEMPLATE_SUFFICES = { "*": !0 };const i = t.parseURI = e => {
      ...
      let t = [];return e.replace(/^(\.\.?(\/|$))+/, "").replace(/\/(\.(\/|$))+/g, "/").replace(/\/\.\.$/, "/../").replace(/\/?[^\/]*/g, function (e) {
        "/.." === e ? t.pop() : t.push(e);
          ...
          a = (t.getDocumentUri = e => e.split("#")[0], t.isTrustedUrl = (e, t) => {
      ...
      if (e && "object" == typeof e) if (void 0 === t ? t = e.id : "string" == typeof e.id && (t = s(t, e.id), e.id = t), Array.isArray(e)) {
        let r = 0,
            i = e.length;for (r = 0; r < i; r++) a(e[r], t);
      } else {
        "string" == typeof e.$ref && (e.$ref = s(t, e.$ref));for (let r in e) "enum" !== r && a(e[r], t);
      }
    });
  }, function (e, t, r) {
    "use strict";
    ...
    Object.defineProperty(t, "__esModule", { value: !0 });var i = arguments,
      ...
      return e && e.__esModule ? e : { default: e };
        ...
        s = r(0),
        a = r(2);let o = {};const l = e => {
      const t = new n.default();let r = e || "en";return { addFormat: (e, r) => {
          t.addFormat(e, r);
        }, language: e => e ? (o[e] || (e = e.split("-")[0]), !!o[e] && (r = e, e)) : r, addLanguage: (e, t) => {
          let r;for (r in s.ERROR_CODES) t[r] && !t[s.ERROR_CODES[r]] && (t[s.ERROR_CODES[r]] = t[r]);let i = e.split("-")[0];if (o[i]) for (r in o[e] = Object.create(o[i]), t) void 0 === o[i][r] && (o[i][r] = t[r]), o[e][r] = t[r];else o[e] = t, o[i] = t;
        }, freshApi: e => {
          const t = l();return e && t.language(e), t;
        }, validate: (e, i, s, a) => {
          const l = new n.default(t, !1, o[r], s, a);"string" == typeof i && (i = { $ref: i }), l.addSchema("", i);let h = l.validateAll(e, i, null, null, "");return !h && a && (h = l.banUnknownProperties()), (void 0).error = h, (void 0).missing = l.missing, (void 0).valid = null === h, (void 0).valid;
        }, validateResult: () => {
          let e = {};return (void 0).validate.apply(e, i), e;
        }, validateMultiple: (e, i, s, a) => {
          const l = new n.default(t, !0, o[r], s, a);"string" == typeof i && (i = { $ref: i }), l.addSchema("", i), l.validateAll(e, i, null, null, ""), a && l.banUnknownProperties();let h = {};return h.errors = l.errors, h.missing = l.missing, h.valid = 0 === h.errors.length, h;
          ...
          if ("string" != typeof e || !/^[A-Z]+(_[A-Z]+)*$/.test(e)) throw new Error("Code name must be a string in UPPER_CASE_WITH_UNDERSCORES");if ("number" != typeof t || t % 1 != 0 || t < 1e4) throw new Error("Code number must be an integer > 10000");if (void 0 !== s.ERROR_CODES[e]) throw new Error("Error already defined: " + e + " as " + s.ERROR_CODES[e]);if (void 0 !== s.ErrorCodeLookup[t]) throw new Error("Error code already used: " + s.ErrorCodeLookup[t] + " as " + t);s.ERROR_CODES[e] = t, s.ErrorCodeLookup[t] = e, s.ERROR_MESSAGES_DEFAULT[e] = s.ERROR_MESSAGES_DEFAULT[t] = r;for (let r in o) {
            let i = o[r];i[e] && (i[t] = i[t] || i[e]);
          }
        }, reset: () => {
          t.reset(), (void 0).error = null, (void 0).missing = [], (void 0).valid = !0;
        }, missing: [], error: null, valid: !0, normSchema: a.normSchema, resolveUrl: a.resolveUrl, getDocumentUri: a.getDocumentUri, errorCodes: s.ERROR_CODES };
    };t.default = l;
  }, function (e, t, r) {
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 });var i = r(0),
      ...
      constructor(e, t, r, i, n) {
        ...
        let t = "";URI_TEMPLATE_GLOBAL_MODIFIERS[e.charAt(0)] && (t = e.charAt(0), e = e.substring(1));let r = "",
            ...
            n = !0,
            s = !1,
            a = !1;"+" === t ? n = !1 : "." === t ? (i = ".", r = ".") : "/" === t ? (i = "/", r = "/") : "#" === t ? (i = "#", n = !1) : ";" === t ? (i = ";", r = ";", s = !0, a = !0) : "?" === t ? (i = "?", r = "&", s = !0) : "&" === t && (i = "&", r = "&", s = !0);let o = [],
            l = e.split(","),
            h = [],
            u = {},
            d = 0,
            c = l.length;for (d = 0; d < c; d++) {
          let e = l[d],
              t = null;if (-1 !== e.indexOf(":")) {
            let r = e.split(":");e = r[0], t = parseInt(r[1], 10);
          }let r = {};for (; URI_TEMPLATE_SUFFICES[e.charAt(e.length - 1)];) r[e.charAt(e.length - 1)] = !0, e = e.substring(0, e.length - 1);let i = { truncate: t, name: e, suffices: r };h.push(i), u[e] = i, o.push(e);
        }const f = e => {
          let t = "",
              o = 0,
              l = 0,
              u = h.length;for (l = 0; l < u; l++) {
            let d = h[l];if (!e && !isFunction(e)) throw new Error("Problem qith value function.");let c = e(d.name);if (null === c || void 0 === c || Array.isArray(c) && 0 === c.length || "object" == typeof c && 0 === Object.keys(c).length) o++;else if (t += l === o ? i : r || ",", Array.isArray(c)) {
              s && (t += d.name + "=");let e = 0;for (u = c.length, e = 0; e < u; e++) e > 0 && (t += d.suffices["*"] && r || ",", d.suffices["*"] && s && (t += d.name + "=")), t += n ? encodeURIComponent(c[e]).replace(/!/g, "%21") : this.notReallyPercentEncode(c[e]);
            } else if ("object" == typeof c) {
              s && !d.suffices["*"] && (t += d.name + "=");let e = !0;for (let i in c) e || (t += d.suffices["*"] && r || ","), e = !1, t += n ? encodeURIComponent(i).replace(/!/g, "%21") : this.notReallyPercentEncode(i), t += d.suffices["*"] ? "=" : ",", t += n ? encodeURIComponent(c[i]).replace(/!/g, "%21") : this.notReallyPercentEncode(c[i]);
            } else s && (t += d.name, a && "" === c || (t += "=")), null !== d.truncate && (c = c.substring(0, d.truncate)), t += n ? encodeURIComponent(c).replace(/!/g, "%21") : this.notReallyPercentEncode(c);
          }return t;
        };return f.varNames = o, { prefix: i, substitution: f };
        ...
        let a = this.errorMessages[e] || i.ERROR_MESSAGES_DEFAULT[e];if ("string" != typeof a) return new i.ValidationError(e, "Unknown error code " + e + ": " + JSON.stringify(t), t, r, n, s);let o = a.replace(/\{([^{}]*)\}/g, function (e, r) {
          let i = t[r];return "string" == typeof i || "number" == typeof i ? i : e;
        });return new i.ValidationError(e, o, t, r, n, s);
      }returnError(e) {
        return e;
      }collectError(e) {
        ...
        let r;if (void 0 !== this.schemas[e]) return r = this.schemas[e], this.resolveRefs(r, t);let i = e,
          ...
          r = this.schemas[i];let e = decodeURIComponent(n);if ("" === e) return this.resolveRefs(r, t);if ("/" !== e.charAt(0)) return;let s = e.split("/").slice(1),
              a = 0,
              o = s.length;for (a = 0; a < o; a++) {
            let e = s[a].replace(/~1/g, "/").replace(/~0/g, "~");if (void 0 === r[e]) {
              r = void 0;break;
            }r = r[e];
        ...
        let a;if (!(t = this.resolveRefs(t))) return null;if (t instanceof i.ValidationError) return this.errors.push(t), t;let o,
            l = this.errors.length,
            h = null,
            u = null;if (this.checkRecursive && e && "object" == typeof e) {
          if (a = !this.scanned.length, e[this.validatedSchemasKey]) {
            ...
            let e = this.scannedFrozenSchemas[o].indexOf(t);if (-1 !== e) return this.errors = this.errors.concat(this.scannedFrozenValidationErrors[o][e]), null;
          }if (this.scanned.push(e), Object.isFrozen(e)) -1 === o && (o = this.scannedFrozen.length, this.scannedFrozen.push(e), this.scannedFrozenSchemas.push([])), h = this.scannedFrozenSchemas[o].length, this.scannedFrozenSchemas[o][h] = t, this.scannedFrozenValidationErrors[o][h] = [];else {
        ...
        }let d = this.errors.length,
            c = this.validateBasic(e, t, s) || this.validateNumeric(e, t, s) || this.validateString(e, t, s) || this.validateArray(e, t, s) || this.validateObject(e, t, s) || this.validateCombinations(e, t, s) || this.validateHypermedia(e, t, s) || this.validateFormat(e, t, s) || this.validateDefinedKeywords(e, t, s) || null;if (a) {
          for (; this.scanned.length;) {
            delete this.scanned.pop()[this.validatedSchemasKey];
          }this.scannedFrozen = [], this.scannedFrozenSchemas = [];
        }if (c || d !== this.errors.length) for (; r && r.length || n && n.length;) {
          let e = r && r.length ? "" + r.pop() : null,
              t = n && n.length ? "" + n.pop() : null;c && (c = c.prefixWith(e, t)), this.prefixErrors(d, e, t);
        }return null !== h ? this.scannedFrozenValidationErrors[o][h] = this.errors.slice(l) : null !== u && (e[this.validationErrorsKey][u] = this.errors.slice(l)), this.handleError(c);
      }validateFormat(e, t) {
        ...
        for (let n in this.definedKeywords) {
          if (void 0 === t[n]) continue;let s = this.definedKeywords[n],
              a = 0,
              o = s.length;for (a = 0; a < o; a++) {
            let o = (0, s[a])(e, t[n], t, r);if ("string" == typeof o || "number" == typeof o) return this.createError(i.ERROR_CODES.KEYWORD_CUSTOM, { key: n, message: o }).prefixWith(null, "format");if (o && "object" == typeof o) {
              let e = o.code;if ("string" == typeof e) {
                if (!i.ERROR_CODES[e]) throw new Error("Undefined error code (use defineError): " + e);e = i.ERROR_CODES[e];
              } else "number" != typeof e && (e = i.ERROR_CODES.KEYWORD_CUSTOM);let t = "object" == typeof o.message ? o.message : { key: n, message: o.message || "?" },
                  r = o.schemaPath || "/" + n.replace(/~/g, "~0").replace(/\//g, "~1");return this.createError(e, t, o.dataPath || null, r);
            }
          }
        }return null;
      }validateBasic(e, t, r) {
        ...
        let r = t.multipleOf || t.divisibleBy;if (void 0 === r) return null;if ("number" == typeof e) {
          let t = e / r % 1;if (t >= s && t < a) return this.createError(i.ERROR_CODES.NUMBER_MULTIPLE_OF, { value: e, multipleOf: r });
        }return null;
      }validateMinMax(e, t) {
        ...
        if ("string" != typeof e || void 0 === t.pattern) return null;return new RegExp(t.pattern).test(e) ? null : this.createError(i.ERROR_CODES.STRING_PATTERN, { pattern: t.pattern }).prefixWith(null, "pattern");
      }validateArray(e, t, r) {
        ...
        if (void 0 === t.items) return null;let n, s;if (Array.isArray(t.items)) {
          let a = e.length;for (s = 0; s < a; s++) if (s < t.items.length) {
        ...
        let n;for (let s in e) {
          let a = r + "/" + s.replace(/~/g, "~0").replace(/\//g, "~1"),
              o = !1;if (void 0 !== t.properties && void 0 !== t.properties[s] && (o = !0, n = this.validateAll(e[s], t.properties[s], [s], ["properties", s], a))) return n;if (void 0 !== t.patternProperties) for (let r in t.patternProperties) {
            if (new RegExp(r).test(s) && (o = !0, n = this.validateAll(e[s], t.patternProperties[r], [s], ["patternProperties", r], a))) return n;
          }if (o) this.trackUnknownProperties && (this.knownPropertyPaths[a] = !0, delete this.unknownPropertyPaths[a]);else if (void 0 !== t.additionalProperties) {
            ...
            } else if (n = this.validateAll(e[s], t.additionalProperties, [s], ["additionalProperties"], a)) return n;
        ...
        let n;if (void 0 !== t.dependencies) for (let s in t.dependencies) if (void 0 !== e[s]) {
          let a = t.dependencies[s];if ("string" == typeof a) {
            if (void 0 === e[a] && (n = this.createError(i.ERROR_CODES.OBJECT_DEPENDENCY_KEY, { key: s, missing: a }).prefixWith(null, s).prefixWith(null, "dependencies"), this.handleError(n))) return n;
          } else if (Array.isArray(a)) {
            let t = 0,
                r = a.lenth;for (t = 0; t < r; t++) {
              let r = a[t];if (void 0 === e[r] && (n = this.createError(i.ERROR_CODES.OBJECT_DEPENDENCY_KEY, { key: s, missing: r }).prefixWith(null, "" + t).prefixWith(null, s).prefixWith(null, "dependencies"), this.handleError(n))) return n;
            }
          } else if (n = this.validateAll(e, a, [], ["dependencies", s], r)) return n;
        }return null;
        ...
        if (void 0 === t.anyOf) return null;let n,
            s,
            a = [],
            o = this.errors.length;this.trackUnknownProperties && (n = this.unknownPropertyPaths, s = this.knownPropertyPaths);let l = !0,
            h = 0,
            u = t.anyOf.length;for (h = 0; h < u; h++) {
          this.trackUnknownProperties && (this.unknownPropertyPaths = {}, this.knownPropertyPaths = {});let i = t.anyOf[h],
              u = this.errors.length,
              d = this.validateAll(e, i, [], ["anyOf", h], r);if (null === d && u === this.errors.length) {
            if (this.errors = this.errors.slice(0, o), this.trackUnknownProperties) {
              for (let e in this.knownPropertyPaths) s[e] = !0, delete n[e];for (let e in this.unknownPropertyPaths) s[e] || (n[e] = !0);l = !1;continue;
            }return null;
          }d && a.push(d.prefixWith(null, "" + h).prefixWith(null, "anyOf"));
        }return this.trackUnknownProperties && (this.unknownPropertyPaths = n, this.knownPropertyPaths = s), l ? (a = a.concat(this.errors.slice(o)), this.errors = this.errors.slice(0, o), this.createError(i.ERROR_CODES.ANY_OF_MISSING, {}, "", "/anyOf", a)) : void 0;
      }validateOneOf(e, t, r) {
        if (void 0 === t.oneOf) return null;let n,
            s,
            a = null,
            o = [],
            l = this.errors.length;this.trackUnknownProperties && (n = this.unknownPropertyPaths, s = this.knownPropertyPaths);let h = 0,
            u = t.oneOf.length;for (h = 0; h < u; h++) {
          this.trackUnknownProperties && (this.unknownPropertyPaths = {}, this.knownPropertyPaths = {});let u = t.oneOf[h],
              d = this.errors.length,
              c = this.validateAll(e, u, [], ["oneOf", h], r);if (null === c && d === this.errors.length) {
            if (null !== a) return this.errors = this.errors.slice(0, l), this.createError(i.ERROR_CODES.ONE_OF_MULTIPLE, { index1: a, index2: h }, "", "/oneOf");if (a = h, this.trackUnknownProperties) {
              for (let e in this.knownPropertyPaths) s[e] = !0, delete n[e];for (let e in this.unknownPropertyPaths) s[e] || (n[e] = !0);
            }
          } else c && o.push(c);
        }return this.trackUnknownProperties && (this.unknownPropertyPaths = n, this.knownPropertyPaths = s), null === a ? (o = o.concat(this.errors.slice(l)), this.errors = this.errors.slice(0, l), this.createError(i.ERROR_CODES.ONE_OF_MISSING, {}, "", "/oneOf", o)) : (this.errors = this.errors.slice(0, l), null);
      }validateNot(e, t, r) {
        if (void 0 === t.not) return null;let n,
            s,
            a = this.errors.length;this.trackUnknownProperties && (n = this.unknownPropertyPaths, s = this.knownPropertyPaths, this.unknownPropertyPaths = {}, this.knownPropertyPaths = {});let o = this.validateAll(e, t.not, null, null, r),
            l = this.errors.slice(a);return this.errors = this.errors.slice(0, a), this.trackUnknownProperties && (this.unknownPropertyPaths = n, this.knownPropertyPaths = s), null === o && 0 === l.length ? this.createError(i.ERROR_CODES.NOT_PASSED, {}, "", "/not") : null;
        ...
        if (!t.links) return null;let i,
          ...
          let s = t.links[n];if ("describedby" === s.rel) {
            let t = new UriTemplate(s.href),
                a = !0,
                o = 0,
                l = t.varNames.length;for (o = 0; o < l; o++) if (!(t.varNames[o] in e)) {
              a = !1;break;
            }if (a) {
...
var _nextCoreValidation = __webpack_require__(/*! next-core-validation */ "./node_modules/next-core-validation/dist/core-next-validation.js");
 ...
 * @extends Object
 */
class AbstractCollection extends _nextCoreObject.AugmentedObject {
  constructor(models, options) {
    ...
    if (models) {
      ...
      this.add(models, (0, _nextCoreUtilities.extend)({ silent: true }, options));
    }
    if (!this.model) {
  ...
  */
  ...
  get(obj) {
    ...
    return this._byId[obj] || this._byId[this.modelId(this._isModel(obj) ? obj._attributes : obj)] || obj.cid && this._byId[obj.cid];
  }
 ...
 */
class AbstractModel extends _nextCoreObject.AugmentedObject {
